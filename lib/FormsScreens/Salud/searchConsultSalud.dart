import '../../config.dart';
import './createConsultSalud.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

class SearchConsultSalud extends StatefulWidget {
  @override
  ...
  _SearchConsultSaludState createState() => _SearchConsultSaludState();
}

class _SearchConsultSaludState extends State<SearchConsultSalud> {
  ...
  Future<void> searchUser() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                NewConsultSalud(UserID: username, PersonalID: PersonalID)),
      );
    } else {
...
void main() {
  ...
  runApp(MaterialApp(
    home: SearchConsultSalud(personalID: personalID),
  ));
}
